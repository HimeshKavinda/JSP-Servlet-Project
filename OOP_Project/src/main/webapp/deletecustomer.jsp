...
<body>
	...
	<center>
	<table id="table1"  border="4" color="blue" width="400" height="600"  >
	...
	<h3><i><b><span class="content-header" data-wow-delay="0.2s" data-wow-duration="2s">Delete Your Booking In Here</span></b></i></h3></br></br>
	...
	<input type="text" name="payment" value="<%= paymemt %>" readonly></br></br>
	<lable>Number Of Clothes:</lable>
	<input type="text" name="clothes" value="<%= clothes %>" readonly></br></br>
    ...
    <div class="container-fluid bg-dark text-white py-4 px-sm-3 px-md-5">
        <p class="m-0 text-center text-white">
            &copy; <a class="text-white font-weight-medium" href="#">CLEAN X</a>. All Rights Reserved. Designed by
            <a class="text-white font-weight-medium" href="#">Perfect Designer</a>
        </p>
    </div>
